...
export const Example4Page = () => {
  ...
  const [dropdownHeaderText, setDropdownHeaderText] =
  ...
  return (
    <Wrapper>
      <Box>
        ...
        <p>
          Selected Item:
          <span data-cy="box-1-selected-name">{clickHeaderText}</span>
        </p>
        <ul data-cy="box-1-items-list" style={{ paddingLeft: 0 }}>
          {items.map((item, i) => (
            <ListItem
              key={i}
      ...
      <Box>
        ...
        <form>
          <p>
            <span data-cy="box-2-selected-count">{selectedCount}</span>
            &nbsp;checkboxes selected
          </p>
          <div className="checkboxes" data-cy="box-2-checkboxes">
            {items.map((item, i) => (
      ...
      <Box>
        ...
        <p>
          Selected Item:&nbsp;
          <span data-cy="box-3-selected-name">{dropdownHeaderText}</span>
        </p>
        <select
      ...
      <Box>
        ...
        <p>
          Selected Item:&nbsp;
          <span data-cy="box-4-selected-name">{hoveredItem}</span>
        </p>
        <ul style={{ paddingLeft: 0 }} data-cy="box-4-items-list">
          {items.map((item, i) => (
            <ListItem
              key={i}
